...
inline constexpr Vector2 operator + (Vector2 v1, Vector2 v2)
{
...
inline constexpr Vector2 operator * (float f, Vector2 v)
{
    return { f * v.x, f * v.y };
}

inline constexpr Vector2 operator * (Vector2 v, float f)
{
    return f * v;
}
